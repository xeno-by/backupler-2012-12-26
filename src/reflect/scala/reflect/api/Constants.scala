...
/** A slice of the Scala reflection cake that defines compile-time constants and operations on them.
 *
...
trait Constants {
  ...
  abstract class ConstantApi {
    ...
    /** Strongly-typed payload of the constant if the constant represents a boolean.
     *  Throws an error otherwise.
     */
    def booleanValue: Boolean

    /** Strongly-typed payload of the constant if the constant represents a byte.
     *  Throws an error otherwise.
     */
    def byteValue: Byte

    /** Strongly-typed payload of the constant if the constant represents a short.
     *  Throws an error otherwise.
     */
    def shortValue: Short

    /** Strongly-typed payload of the constant if the constant represents a char.
     *  Throws an error otherwise.
     */
    def charValue: Char

    /** Strongly-typed payload of the constant if the constant represents an integer.
     *  Throws an error otherwise.
     */
    def intValue: Int

    /** Strongly-typed payload of the constant if the constant represents a long.
     *  Throws an error otherwise.
     */
    def longValue: Long

    /** Strongly-typed payload of the constant if the constant represents a float.
     *  Throws an error otherwise.
     */
    def floatValue: Float

    /** Strongly-typed payload of the constant if the constant represents a double.
     *  Throws an error otherwise.
     */
    def doubleValue: Double

    /** Strongly-typed payload of the constant if the constant represents a string.
     *  Throws an error otherwise.
     */
    def stringValue: String

    /** Strongly-typed payload of the constant if the constant represents a reference to a class.
     *  Throws an error otherwise.
     */
    def typeValue: Type

    /** Strongly-typed payload of the constant if the constant represents a reference to an enum value.
     *  Throws an error otherwise.
     */
